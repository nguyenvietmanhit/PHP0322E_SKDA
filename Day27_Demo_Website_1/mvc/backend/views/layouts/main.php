...
- Chuyển từ giao diện tĩnh thành layout động:
+ Copy toàn bộ các css, js, image, font ... vào thư mục
assets của mô hình MVC
+ Copy nội dung file trang chủ của template:
mockup_html/backend/index.html paste vào file main.php
+ Ktra lại toàn bộ đường dẫn tới các file css, js, image ...
để đúng với mô hình MVC
+ Chuyển thành layout động
-->
<!DOCTYPE html>
<html>
<head>
